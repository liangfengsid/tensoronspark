...
def test_delta_weight_combiner():
	...
	result1 = combiner.compute(origin, updated_1, worker_id='1')
	result2 = combiner.compute(result1, updated_2, worker_id='2')
	result3 = combiner.compute(result2, updated_3, worker_id='2')
	valid_result1 = np.array([2, 2, 2])
	valid_result2 = np.array([5, 5, 4])
	valid_result3 = np.array([4, 6, 5])
